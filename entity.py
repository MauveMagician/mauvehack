...
from components.components import Fighter, BasicMonster, Inventory, Potion, PotionEffect, PotionHealing, Downstairs, Upstairs, HealSpell, DrainSpell
...
def build_feature_entity(entry):
    entity = Entity(
        entry['char'],
        entry['color'],
        entry['name'],
